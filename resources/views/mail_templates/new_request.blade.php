...
<body style="color:#444444;font-size: 22px;font-style: normal;font-weight: bold;line-height: 150%;letter-spacing: normal;text-align: left;font-family:Georgia, 'Times New Roman', Times, serif;">
    ...
    <h3>Hi ,</h3>
    <h4>You have received a new document for sign. Please follow the below link to access the document file.</h4>

   
    
    <div style="margin-top:20px;text-align:center;">
    <a href="http://localhost:3000/signer/sign/?d={{$user_d['requestUID']}}&s={{$user_d['signerUID']}}" style="background:#2baadf;color:#ffffff;text-align:center;text-decoration:none;width:150px;margin:0px auto;font-size: 16px;padding: 15px;border-radius:4px;border:3px solid #0fde20;">Open Document</a>
    </div>
