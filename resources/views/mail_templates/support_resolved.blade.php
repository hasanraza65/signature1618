                                                ...
                                                <td class="column column-1"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h1
                                                                    ...
                                                                    <span class="tinyMce-placeholder">Dear {{ rtrim($user_d['receiver_name']) }},</span></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">We are pleased to inform you
                                                                        that your support ticket has been successfully
                                                                        resolved.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <table style="border: 1px solid #101112; border-collapse: collapse; width:100%; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">
                                                                    <tr>
                                                                        <td style="border: 1px solid #101112; padding:8px;"> Ticket Status
                                                                           </td>
                                                                        <td style="border: 1px solid #101112; padding:8px;"> {{$user_d['status']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="border: 1px solid #101112; padding:8px;">Subject
                                                                           </td>
                                                                        <td style="border: 1px solid #101112; padding:8px;"> {{$user_d['subject']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="border: 1px solid #101112; padding:8px;">Date Submitted
                                                                            </td>
                                                                        <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['formattedDateSubmitted']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="border: 1px solid #101112; padding:8px;">Resolution Date                                                                          </td>
