										...
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 20px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Thank you for subscribing to Signature1618! We are thrilled to have you on board. Your payment for the {{$user_d['plan_name']}} has been successfully processed. Here are your subscription details:</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<table style="border: 1px solid #101112; border-collapse: collapse; width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">
                                                                    ...
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">Amount Paid</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['amount']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">Subscription Period</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['subscription_period']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                    ...
                                                    <table class="button_block block-4" width="450px" align="center" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
...
<a href="{{ env('APP_URL') }}" target="_blank" style="background-color:#009c4a;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:10px;border-right:0px solid transparent;border-top:0px solid transparent;color:#ffffff;display:block;font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:400;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:65%;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:22px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 44px;">Login To Your Account</span></span></a>{{---[if mso]></center></v:textbox></v:roundrect><![endif]--}}</div>
													...
													<table class="paragraph_block block-8" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">If you have any questions or need assistance, our support team is here to help. You can reach us by opening a support ticket via your account.<br>Thank you for choosing Signature1618.</p>
																</div>
															</td>
														</tr>
													</table>
