                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0;">Unfortunately, your subscription has failed to renew. To avoid interuptions to your documents signing, kindly update your payment information or upgrade your subscription now.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                    <table class="button_block block-4" width=350px" align="center" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
...
<![endif]--}}<a href="https://signature1618.app/login" target="_blank" style="background-color:red;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:10px;border-right:0px solid transparent;border-top:0px solid transparent;color:#ffffff;display:block;font-family:Arial, Helvetica, sans-serif;font-size:22px;font-weight:400;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:65%;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:22px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 44px;">Renew Now</span></span></a>{{---[if mso]></center></v:textbox></v:roundrect><![endif]--}}</div>
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0;">Here are the details of your subscription:</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <table style="border: 1px solid #101112; border-collapse: collapse; width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">Plan</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['plan_name']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112;

 padding: 8px;">Status</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['substatus']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">End Date</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{ \App\Helpers\Common::dateFormat($user_d['end_date']) }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">Price</td>
                                                                      <td style="border: 1px solid #101112; padding: 8px;">{{$user_d['price']}}</td>
                                                                    </tr>
                                                                  </table>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="paragraph_block block-8" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <Thank style="margin: 0;">If you have any questions or need assistance, please don't hesitate to contact our support team. Thank you for being a valued client of Signature1618.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    ...
                                                                    <p style="margin: 0;">Signature1618 Support</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="pad">
                                                                                                <div style="color:#ebebeb;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                                                                    <p style="margin: 0;">Email Sent Via <a href="signature1618.com" target="_blank" style="text-decoration: none; color: #FFD700;" rel="noopener" bis_size="{&quot;x&quot;:874,&quot;y&quot;:753,&quot;w&quot;:104,&quot;h&quot;:18,&quot;abs_x&quot;:874,&quot;abs_y&quot;:812}">Signature1618</a></p>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
