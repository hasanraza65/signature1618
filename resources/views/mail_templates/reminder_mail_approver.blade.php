...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
  ...
  <tr  >
    <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
          ...
          <div  >
            <h3>Reminder!</h3><br>
            There is a document still waiting for your approval. Please click on the button below to approve the file.
          </div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
            ...
            <td align="center" height="50" style="height:50px;">
                ...
                <a href="{{ env('APP_URL') }}/approve/?d={{$user_d['requestUID']}}&s={{$user_d['signerUID']}}" target="_blank"  style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Approve Document</span></a> 
