    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0px; border: 1px solid #ebebeb;">
        ...
        <div style="padding: 20px;">
            ...
            <p style="font-size: 16px; line-height: 1.5; margin: 0 0 10px 0;">
                This is a friendly reminder to approve the dossier from {{$user_d['company_name']}}. The approval request was sent to you earlier, but we have not yet received your response.
            </p>

            <!-- Access Dossier Button -->
            <a href="{{ env('APP_URL') }}/approve/?d={{$user_d['requestUID']}}&a={{$user_d['signerUID']}}" style="display: block; width: 50%; max-width: 300px; margin: 20px auto; padding: 12px; background-color: #009c4a; color: #ffffff; text-align: center; border-radius: 10px; text-decoration: none; font-size: 19px;">Access Dossier</a>
        ...
        <div style="background-color: #0018A8; color: #ffffff; padding: 20px; text-align: center; font-size: 16px; line-height: 1.5;">
            <p style="margin: 0;">Request Sent Via Signature1618</p>
