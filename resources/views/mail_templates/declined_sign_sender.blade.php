														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">{{$user_d['receiver_name']}} has refused to sign {{$user_d['file_name']}}.<br>As such, the dossier is no longer available for signing. You may consult the dossier via this link.</p>
																</div>
															</td>
														</tr>
													</table>
