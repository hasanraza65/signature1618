                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#101112; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 400; letter-spacing: 0px; line-height: 120%; text-align: left;">
                                                                    <p style="margin: 0;">This is a friendly reminder to sign the dossier from {{$user_d['company_name']}}. The signature request was sent to you earlier, but we have not yet received your response.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
