...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
				<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;">
					...
					<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #f8f4f4; color: #333333; font-family: Arial, Helvetica, sans-serif; margin: 0 auto; max-width: 600px;">
						<tbody>
							<tr>
										...
										<tbody>
											...
											<tr>
												<td style="padding-bottom: 20px; text-align: center;">
													<a href="{{ env('APP_URL') }}" style="background-color: #009c4a; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-size: 16px;">Get Started</a>
												</td>
											</tr>
											<tr>
												<td style="padding-bottom: 20px; font-size: 16px; line-height: 1.6;">
													...
													<p>Explore the powerful features of Signature1618 and start your free trial today!</p>
												</td>
											</tr>
											<tr>
												<td style="font-size: 16px; line-height: 1.6;">
													<p>Thank you for choosing Signature1618. We look forward to helping you transform your document signing experience.</p>
													<p>Best regards,<br>Signature1618 Team</p>
												</td>
											</tr>
										</tbody>
									</table>
