    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0px; border: 1px solid #ebebeb;">
        ...
        <div style="padding: 20px;">
            ...
            <div style="text-align: center; margin: 20px 0;">
                <a href="{{ env('APP_URL') }}/request-details/?r={{$user_d['requestUID']}}" style="background-color: #009c4a; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">
                    Access Dossier
                </a>
            </div>
